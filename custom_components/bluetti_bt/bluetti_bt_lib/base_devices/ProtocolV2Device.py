...
class ProtocolV2Device(BluettiDevice):
    def __init__(self, address: str, type: str, sn: str):
        ...
        self.struct.add_decimal_field('total_dc_consumption', 150)
        self.struct.add_decimal_field('total_ac_consumption', 152)
        self.struct.add_decimal_field('power_generation', 154) # Total power generated since last reset (kwh)
        self.struct.add_decimal_field('total_grid_consumption', 156)
        self.struct.add_decimal_field('total_grid_feed', 158)
